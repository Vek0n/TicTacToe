...
public class PlayerVsPlayerMisereActivity extends AppCompatActivity {
    ...
    TextView resultsDraw, resultsPlayerWin, resultsPlayerTwoWin, circleStarts, crossStarts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_player_vs_player_inverted_tic_tac_toe);
        ...
        mAdView = (AdView) findViewById(R.id.adViewMiserePvP);
        ...
        homeBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(PlayerVsPlayerMisereActivity.this, StartUpActivity.class);
